...
//生成
//============================
CEnemy002_AlterEgo* CEnemy002_AlterEgo::Create(D3DXVECTOR3 pos, CEnemyAction_AlterEgoAttack* action)
{
	//生成
	...
	//パラメータの設定
	pEnemy->SetPos(pos);
	pEnemy->m_pMainEnemyAction = action;
