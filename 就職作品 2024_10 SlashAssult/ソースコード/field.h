...
public:
	...
	//定数の宣言
	static const std::string TEXTUREPATH;				//読み込むテクスチャ
	...
	D3DXVECTOR3 WidthCollision(D3DXVECTOR3 pos, float radius);	//メッシュの横の当たり判定
...
private:
	...
	void Load();														//読み込み
	bool CheckHit(int count, D3DXVECTOR3 pos, VERTEX_3D* vtx, WORD* idx);	//ヒット確認
