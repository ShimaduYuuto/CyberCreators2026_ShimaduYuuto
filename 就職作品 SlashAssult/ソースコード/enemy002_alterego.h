...
class CEnemyAction_AlterEgoAttack;
...
public:
	...
	//生成
	static CEnemy002_AlterEgo* Create(D3DXVECTOR3 pos, CEnemyAction_AlterEgoAttack* action);
...
private:
	CEnemyAction_AlterEgoAttack* m_pMainEnemyAction;	//ボス本体のポインタ
};
