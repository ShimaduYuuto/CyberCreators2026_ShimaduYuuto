...
const D3DXVECTOR3 CGauge_PlayerLife::SIZE = { 200.0f, 20.0f, 0.0f };		//ゲージ枠のサイズ
const D3DXVECTOR3 CGauge_PlayerLife::SIZE_GAUGE = { 170.0f, 20.0f, 0.0f };	//ゲージのサイズ
...
void CGauge_PlayerLife::SetGauge(float max)
{
	...
	{
		//ゲージの生成
		m_pGauge = CGauge::Create(POS, SIZE_GAUGE, max);
